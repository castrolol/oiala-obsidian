...
O que deixa bem claro que — **não são humanos.**  
Os dados sugerem que os terráqueos **não foram a primeira civilização desenvolvida na terra** e que essa civilização passada estava fugindo, lutando contra algo.

Ao aprofundarem as escavações, os arqueólogos encontram uma câmara subterrânea oculta, selada por tecnologia completamente incompatível com qualquer coisa conhecida pelos terráqueos — feita de um metal orgânico que parece estar "vivo".

Esse momento gera comoção global, muitas pessoas dizem que devemos nos manter distantes dessa descoberta e não interagir com essas construções. 
Os Terráqueos, arrogantes, veem isso como uma oportunidade de obter poder a partir de uma tecnologia esquecida.

A **ARX Tecnogênica** surge originalmente como uma divisão estatal de engenharia arqueotecnológica logo após a descoberta das ruínas. Seu objetivo inicial era:

- Coordenar escavações.
- Conter e estudar qualquer risco biológico ou energético da antiga civilização.
- Catalogar e preservar os achados com fins científicos.

Com apoio de bancos interplanetários, corporações bélicas e elites, a ARX se separa totalmente dos governos e assume posse das ruínas como entidade soberana — tornando o local um território corporativo independente.
...
> 
> Per Arx, Ordo
> "Pela Fortaleza, a Ordem"
> "A ordem nasce da fortaleza".
> 
> Significado:
> "Arx" (fortaleza) representa força, proteção, autoridade, centralização de poder.
> 
...
- Torres viraram “órgãos sensoriais” — olhos biológicos vigiam os céus e gritam quando detectam movimento.
